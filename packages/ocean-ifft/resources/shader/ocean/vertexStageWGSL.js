// Phase B refactor — ocean surface vertex shader entrypoint.
// Preserves the existing morph + IFFT cascade displacement pipeline and adds
// a Gerstner overlay layer that sums up to 3 hero waves on top. The Gerstner
// function lives in fragments/gerstner.wgsl.js and is concatenated into the
// wgslFn compilation unit alongside the existing helpers.

import { wgslFn, varyingProperty } from "three/tsl";
import { gerstnerWGSL } from "./fragments/gerstner.wgsl.js";
